...
static const double accel_speed = -0.75; //2400 dpi
...
/* Drawing tablet: map the pen to the focused window's area (1) or to the
 * whole active output (0). */
static const int tabletmaptosurface = 0;
